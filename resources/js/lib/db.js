/* AUTO-GENERATED from public/prototype/js/data.js by scripts/port-proto-module.mjs.
...
export {
    ...
    cashHandoversInRange,
    cashHandoversThisMonth,
    cashHandoversToday,
    cashInHandTotal,
    changeInvoiceStatus,
    changeStudentStatus,
    ...
    followupsToday,
    followupsUpcoming,
    generateCashReceiptNo,
    generateInvoiceNo,
    generateReceiptNo,
    generateStudentCode,
    generateTeacherPayVoucherNo,
    hasAnyOverride,
    ...
    pendingTeacherPaymentsCountForUser,
    primaryEnrollment,
    recordPayment,
