...
export function TeacherPaymentVoucher({ id }) {
...
/* The popup window has no access to the bundled CSS, so the voucher ships the same minimal
   stylesheet the prototype's printTeacherPaymentVoucher() wrote into it. */
const PRINT_CSS = `
...
export function printTeacherPaymentVoucher(id, onBlocked) {
    const body = renderToStaticMarkup(<TeacherPaymentVoucher id={id} />);
